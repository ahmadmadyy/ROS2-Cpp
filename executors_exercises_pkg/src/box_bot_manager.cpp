...
public:
  BoxBotManager(std::string odom_topic_name1, std::string odom_topic_name2, std::string odom_topic_name3, 
    ...
    odom1_callback_group_ = this->create_callback_group(rclcpp::CallbackGroupType::MutuallyExclusive);
    odom2_callback_group_ = this->create_callback_group(rclcpp::CallbackGroupType::MutuallyExclusive);
    odom3_callback_group_ = this->create_callback_group(rclcpp::CallbackGroupType::MutuallyExclusive);
    ...
    // Publishers
    publisher1_ = this->create_publisher<std_msgs::msg::String>("/reached_goal/box_bot_1", 1);
    publisher2_ = this->create_publisher<std_msgs::msg::String>("/reached_goal/box_bot_2", 1);
    publisher3_ = this->create_publisher<std_msgs::msg::String>("/reached_goal/box_bot_3", 1);
  }
...
int main(int argc, char *argv[]) {
  ...
  std::shared_ptr<BoxBotManager> box_manager_node =
      std::make_shared<BoxBotManager>(
            "/box_bot_1/odom", "/box_bot_2/odom", "/box_bot_3/odom",
            goal1, goal2, goal3);
